...
class ItemsResource(Resource):
    ...
    def patch(self,id):
        ...
        if qry is not None:
            ...
            db.session.commit()
            return marshal(qry, Items.respon_fields),200, { 'Content-Type': 'application/json' }
        return {'status': 'NOT_FOUND','message':'item not found'},404, { 'Content-Type': 'application/json' }
    ...
    def delete(self,id):
        ...
        if qry is not None:
            ...
            db.session.commit()
            return str(marshal(qry, Items.respon_fields))+"has been deleted",200, { 'Content-Type': 'application/json' }
        return {'status': 'NOT_FOUND','message':'item not found'},404, { 'Content-Type': 'application/json' }
